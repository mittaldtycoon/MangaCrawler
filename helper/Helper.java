...
import mangaCrawler.MangaCrawler;
...
public class Helper {
	...
	public static String extractSubString(String htmlContent, String prefix, String surfix) {
		if (htmlContent == null)
			return null;
	...
	public static boolean downloadAndStoreImage(Integer imageOrder, String imageLink, String chapterDirectory) {
		if (imageOrder == null || imageLink == null || chapterDirectory == null)
			return false;

		String imageLocation = chapterDirectory + "\\" + imageOrder
				+ ".jpg";
		if (!NetworkingFunctions.downloadImage(imageLink,
				imageLocation))
			return false;

		System.out.println("Download " + imageLink + " to "
				+ imageLocation);
